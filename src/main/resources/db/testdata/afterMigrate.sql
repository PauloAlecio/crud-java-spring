...
-- TRUNCATE TABLE "endereco" RESTART IDENTITY;

-- TRUNCATE TABLE "cidade" RESTART IDENTITY;

-- TRUNCATE TABLE "pessoa" RESTART IDENTITY;

-- TRUNCATE TABLE "sexo" RESTART IDENTITY;
-- ALTER TABLE public.sexo
--     ALTER COLUMN id TYPE bigint;
-- ALTER TABLE IF EXISTS public.sexo
--     ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY;

-- ALTER TABLE IF EXISTS public.sexo
--     ALTER COLUMN id SET STORAGE DEFAULT;

-- TRUNCATE TABLE "estado" RESTART IDENTITY;
